...
import com.example.CyTrack.Workouts.WorkoutRecyclerInterface;
...
public class WorkoutsRecyclerViewAdapter extends RecyclerView.Adapter<WorkoutsRecyclerViewAdapter.ViewHolder> {
     ...
     */
    private final com.example.CyTrack.Workouts.WorkoutRecyclerInterface workoutRecyclerInterface;
     ...
     */
    private final ArrayList<com.example.CyTrack.Workouts.WorkoutObject> workoutList;
     ...
     */
    public WorkoutsRecyclerViewAdapter(Context context, ArrayList<WorkoutObject> workoutList, com.example.CyTrack.Workouts.WorkoutRecyclerInterface workoutRecyclerInterface) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(view, workoutRecyclerInterface);
    }
