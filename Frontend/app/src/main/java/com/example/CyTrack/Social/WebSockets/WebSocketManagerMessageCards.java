package com.example.CyTrack.Social.WebSockets;
 ...
 */
public class WebSocketManagerMessageCards {

    private static WebSocketManagerMessageCards instance;
    private MyWebSocketClient webSocketClient;
    private WebSocketListener webSocketListener;

    private WebSocketManagerMessageCards() {}
     ...
     */
    public static synchronized WebSocketManagerMessageCards getInstance() {
        if (instance == null) {
            instance = new WebSocketManagerMessageCards();
        }
        return instance;
    }
