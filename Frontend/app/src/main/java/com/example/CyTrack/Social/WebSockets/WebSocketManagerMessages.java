 ...
 */
public class WebSocketManagerMessages {

    private static WebSocketManagerMessages instance;
    private MyWebSocketClient webSocketClient;
    private WebSocketListener webSocketListener;

    private WebSocketManagerMessages() {}
     ...
     */
    public static synchronized WebSocketManagerMessages getInstance() {
        if (instance == null) {
            instance = new WebSocketManagerMessages();
        }
        return instance;
    }
