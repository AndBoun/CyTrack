package com.example.CyTrack.Badges.Websocket;
 ...
 */
public class WebSocketManagerBadges {

    private static WebSocketManagerBadges instance;
    private MyWebSocketClient webSocketClient;
    private WebSocketListener webSocketListener;

    private WebSocketManagerBadges() {}
     ...
     */
    public static synchronized WebSocketManagerBadges getInstance() {
        if (instance == null) {
            instance = new WebSocketManagerBadges();
        }
        return instance;
    }
